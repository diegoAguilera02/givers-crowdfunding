...
const data = [
    {link: '/create-campaign', label: 'Crear Nueva Campaña', icon: IconFolderPlus},
    {link: '/dashboard', label: 'Mi Dashboard', icon: IconHome},
    {link: '', label: 'Campañas Seguidas', icon: IconHeart},
    {link: '', label: 'Campañas Fundadas', icon: IconFileDollar},
];
