...
const mockdata = [
    ...
    },
    {
        ...
        title: 'Crowdfunding',
        description:
            `Ready to rally the resources you need to do good? Givers offers project, recurring and debt crowdfunding. We can even help you design a great campaign to give you the highest chance to succeed!`,
    ...
    },
    {
        ...
        title: 'Partnerships',
        description:
            `Givers partners with leading brands, institutions and governments to support changemakers. We accelerate change through challenges, accelerators and funding programs.`,
    ...
    return (
        <Box {...boxProps}>
            <Box mb="lg">
                ...
                <Text {...subtitleProps}>Givers exists to support social impact projects, enterprises and founders.
